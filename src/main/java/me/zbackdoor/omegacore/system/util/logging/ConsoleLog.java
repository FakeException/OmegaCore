...
public class ConsoleLog {
    ...
    private String logFormat = "[&3Omega&bCore&r] [{omegacore_log_level}]: {omegacore_log_message}";
    ...
    public void log(ConsoleLevel level, String message, Object... args) {
        log(Messages.colour(logFormat
                .replace("{omegacore_log_level}", level.getTagColour() + level.getTag() + ChatColor.RESET)
                .replace("{omegacore_log_message}", message)), args);
    }
